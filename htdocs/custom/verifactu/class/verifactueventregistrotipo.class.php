...
class VerifactuEventRegistroTipo extends CommonObject
{
    public $element       = 'verifactueventregistrotipo';       // Identificador interno
    public $table_element = 'c_verifactu_event_registro_tipos';    // Nombre de la tabla (sin prefijo)
