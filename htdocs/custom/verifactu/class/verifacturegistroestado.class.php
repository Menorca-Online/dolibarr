...
class VerifactuRegistroEstado extends CommonObject
{
    public $element       = 'verifacturegistroestado';       // Identificador interno
    public $table_element = 'c_verifactu_registro_estados';    // Nombre de la tabla (sin prefijo)
