...
class VerifactuEstadoBatch extends CommonObject
{
    public $element       = 'verifactu_estado_batch';       // Identificador interno
    public $table_element = 'c_verifactu_estado_batch';    // Nombre de la tabla (sin prefijo)
