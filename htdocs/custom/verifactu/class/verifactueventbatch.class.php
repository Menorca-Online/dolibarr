...
class VerifactuEventBatch extends CommonObject
{
    public $element       = 'verifactu_event_batch';       // Identificador interno
    public $table_element = 'verifactu_event_batches';    // Nombre de la tabla (sin prefijo)
    ...
    {
        $registros = array();
        $sql = "SELECT rowid FROM " . MAIN_DB_PREFIX . "verifactu_event_registros WHERE fk_batch = " . (int)$this->id;
