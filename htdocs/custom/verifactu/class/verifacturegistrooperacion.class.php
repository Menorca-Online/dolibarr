...
class VerifactuRegistroOperacion extends CommonObject
{
    public $element       = 'verifacturegistrooperacion';       // Identificador interno
    public $table_element = 'c_verifactu_registro_operaciones';    // Nombre de la tabla (sin prefijo)
